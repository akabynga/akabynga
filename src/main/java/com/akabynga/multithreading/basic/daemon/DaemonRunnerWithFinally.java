...
public class DaemonRunnerWithFinally {
    ...
    private static final class Task implements Runnable {
        private static final String MESSAGE_START_WORKING = "I'm working";
        private static final String MESSAGE_END_WORKING = "I'm finished";
