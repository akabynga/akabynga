...
public class Runner extends BaseRunner {
    public static void main(String[] args) throws InterruptedException {
        ...
        Fork[] forks = new Fork[Runner.PHILOSOPHERS_COUNT];
        for (int i = 0; i < forks.length; i++) {
            forks[i] = new Fork(i);
        }

        Philosopher[] philosophers = new Philosopher[Runner.PHILOSOPHERS_COUNT];
        ...
        waitMillis(BaseRunner.DINNER_DURATION_IN_MS);
